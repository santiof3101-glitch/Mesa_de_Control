...
function buildPrestacionTemplate(operationType, maritalType) {
  ...
  const expensesClause = isConsignment
    ...
    : "SEXTA: GASTOS.- Todos los gastos de tipo mecanico, repuestos, avaluos u otros que deban ejecutarse en el VEHICULO, incluyendo gastos de combustible, aceite, etc., podran ser realizados por EL INTERMEDIARIO para la venta futura, considerando que se acordo el precio en este contrato. EL CLIENTE debera cancelar y estar al dia con todos los valores, tasas o tributos por concepto de multas, matriculacion, SPPAT u otros de tipo legal que antecedan a la firma de este contrato para el efectivo traspaso del vehiculo, o se podra aplicar lo senalado en la Clausula Tercera.";
  const declarationClause = isConsignment
    ? "OCTAVA: DECLARACIONES.- EL CLIENTE con la suscripcion de este instrumento declara lo siguiente: 8.1. Que sobre el VEHICULO de su propiedad no pesa gravamen alguno, prohibicion de enajenar y no mantiene antecedentes de cualquier naturaleza en el sistema judicial del pais que puedan impedir su transferencia, incluso de transferencias que anteriores, declarando que el VEHICULO se encuentra totalmente saneado y, si llega a existir algun problema judicial de cualquier naturaleza; incluyendo, pero sin limitarse a prohibiciones de enajenar, denuncias de robo, entre otros, sera su directa responsabilidad, incluso una vez firmado el respectivo contrato de venta con el tercero. EL CLIENTE debera responder frente al EL INTERMEDIARIO y el comprador; sin perjuicio, de las acciones civiles y penales que se puedan presentar. Esto da la posibilidad a EL INTERMEDIARIO de terminar inmediatamente el contrato, solicitar el valor pagado a EL CLIENTE -en caso de que se haya transferido el valor- en el plazo de 3 dias de enviada la comunicacion y, si es posible transferir el vehiculo a EL CLIENTE y/o realizar todos los tramites para resciliar el contrato firmado. Si EL CLIENTE no devuelve el valor(es) en el plazo de 5 dias, se podra cobrar el maximo interes convencional determinado por el BCE hasta que cancele el mismo, mas todos los gastos legales correspondientes a transferencia de dominio, compensacion al COMPRADOR, gastos de retencion del vehiculo, o incluso los honorarios de abogados de los procesos legales correspondientes; 8.2. EL CLIENTE autoriza a verificar, validar y contrastar la informacion personal, legal, registral, comercial y aquella vinculada a sus antecedentes financieros o crediticios; asi como todo aquella relacionada con la evaluacion de riesgos del vehiculo, historial de propiedad, antecedentes, entre otros, a traves de cualquier fuente publica o privada que considere pertinente, antes, durante o despues de la operacion. 8.3. Que, a la fecha de suscripcion de este instrumento, se entrego el VEHICULO en el estado fisico y mecanico suscrito en el acta de entrega recepcion, declarando que el kilometraje no ha sido manipulado o alterado y que el VEHICULO se encuentra en condiciones mecanicas y esteticas aceptables, no mantiene vicios ocultos y no ha ocultado informacion relevante para la negociacion como choques, danos, siniestros, entre otros. Si EL INTERMEDIARIO comprueba que EL CLIENTE omitio lo senalado, podra cobrar dichos valores, devolver el VEHICULO contra entrega de los valores cancelados o iniciar las acciones legales correspondientes; 8.4. Que se compromete a pagar en el plazo de 48 horas cualquier multa o sancion impuesto por una autoridad que le correspondan del periodo en el cual fue propietario, incluso si el VEHICULO ya esta encuentra vendido a un tercero, o se podran iniciar acciones legales por dichos valores; 8.5. Que entregara todos los documentos necesarios en el plazo maximo de 48 horas de ser solicitados para el traspaso del vehiculo y acudira a la firma correspondiente; si en este tiempo no lo hace, EL INTERMEDIARIO a su solo criterio podra dar por terminado este contrato y cobrar el valor de QUINIENTOS DOLARES DE LOS ESTADOS UNIDOS DE AMERICA por concepto de servicios administrativos, exhibicion y gestion y devolver el VEHICULO una vez cancelado este monto; asi como los gastos de alistamiento o mecanicos, si los hubiera; 8.6. Que autoriza a que EL INTERMEDIARIO pueda ceder o delegar total o parcialmente los derechos y/o obligaciones del presente contrato a cualquier tercero sin necesidad de notificacion alguna, en las mismas condiciones a las aqui senaladas. 8.7. Que mantendra indemne a EL INTERMEDIARIO de cualquier accion judicial que se presente en su contra respecto del VEHICULO, y debera cubrir cualquier gastos, costas u honorarios de abogados que se hayan originado por este motivo; 8.8. Que mientras el VEHICULO se encuentre con EL INTERMEDIARIO no podra ser ofertado o comercializado directamente por EL CLIENTE o por ningun tercero. 8.9. Que no podra dar por terminado este contrato cuando el VEHICULO se encuentre reservado a un tercero o que el tercero haya realizado pagos parciales o totales como reserva y, asi lo demuestra EL INTERMEDIARIO. Si esto ocurre, EL CLIENTE conoce y esta conforme en que debera pagar una multa de QUINIENTOS DOLARES DE LOS ESTADOS UNIDOS DE AMERICA correspondiente a servicios administrativos, publicidad, etc. Este valor es independiente a los gastos por alistamiento o mecanicos realizados conforme la liquidacion; hasta que EL CLIENTE no cancele la multa antes determinada como los gastos, no se procedera a la devolucion del VEHICULO. 8.10. Conoce que, con el fin de mantener una buena comunicacion y asesoria, podra acudir a nuestra canal de atencion al cliente al numero 0992963898."
    : "OCTAVA: DECLARACIONES.- EL CLIENTE con la suscripcion de este instrumento declara lo siguiente: 8.1. Que el VEHICULO es de su propiedad y no fue obtenido de manera ilegal, que sobre este no pesa gravamen alguno, prohibicion de enajenar y no mantiene antecedentes de cualquier naturaleza en el sistema judicial del pais que pueda impedir su transferencia, incluso de transferencias que se hayan efectuado antes, declarando que el vehiculo se encuentra totalmente saneado y, si llega a existir algun problema judicial de cualquier naturaleza; incluyendo, pero sin limitarse a prohibiciones de enajenar, denuncias de robo, entre otros, sera su directa responsabilidad, incluso una vez firmado el respectivo contrato de venta con un tercero. EL CLIENTE debera responder frente al EL INTERMEDIARIO y el comprador; sin perjuicio, de las acciones civiles y penales que se puedan presentar. Esto dara la posibilidad a EL INTERMEDIARIO de terminar inmediatamente el contrato, y solicitar el valor pagado a EL CLIENTE. Si EL CLIENTE no devuelve el valor(es) en el plazo de 5 dias, se podra cobrar el maximo interes convencional determinado por el BCE hasta que cancele el mismo, mas todos los gastos legales correspondiente a la transferencia de dominio, compensacion al COMPRADOR, gastos de retencion del vehiculo, o incluso los honorarios de abogados de los procesos legales correspondientes; 8.2. EL CLIENTE autoriza a verificar, validar y contrastar la informacion personal, legal, registral, comercial y aquella vinculada a sus antecedentes financieros o crediticios; asi como todo aquella relacionada con la evaluacion de riesgos del vehiculo, historial de propiedad, antecedentes, entre otros, a traves de cualquier fuente publica o privada que considere pertinente, antes, durante o despues de la operacion. 8.3. Que, a la fecha de suscripcion de este instrumento, se entrego el VEHICULO en el estado fisico y mecanico suscrito en el acta de entrega recepcion, declarando EL CLIENTE que el kilometraje no ha sido manipulado o alterado y que el VEHICULO se encuentra en condiciones mecanicas y esteticas aceptables, no mantiene vicios ocultos y no ha ocultado informacion relevante para la negociacion como choques, danos, siniestros, entre otros. Si EL INTERMEDIARIO comprueba que EL CLIENTE omitio lo senalado, podra cobrar dichos valores previa negociacion con este, devolver el VEHICULO contra entrega de los valores cancelados o iniciar las acciones legales correspondientes; 8.4. Que se compromete a pagar en el plazo de 48 horas cualquier multa o sancion impuesto por una autoridad que le correspondan del periodo en el cual fue propietario, incluso si el VEHICULO ya esta encuentra vendido a un tercero, o se podran iniciar acciones legales por dichos valores; 8.5. Que se compromete a entregar todos los documentos necesarios que se requieran para el posterior traspaso del VEHICULO, incluso si el monto ya se encuentra cancelado, 8.6. Que autoriza que EL INTERMEDIARIO pueda ceder o delegar total o parcialmente los derechos y/o obligaciones del presente contrato a cualquier tercero sin necesidad de notificacion alguna, en las mismas condiciones a las aqui senaladas, 8.7. Que mantendra indemne a EL INTERMEDIARIO de cualquier accion judicial que se presente en su contra respecto del vehiculo, y debera cubrir cualquier gastos, costas u honorarios de abogados que se hayan originado por este motivo; 8.8. Que mientras el VEHICULO se encuentre con EL INTERMEDIARIO no podra ser ofertado o comercializado directamente por EL CLIENTE o por ningun tercero., 8.9. Conoce que, con el fin de mantener una buena comunicacion y asesoria, podra acudir a nuestra canal de atencion al cliente al numero 0992963898.";
  const notificationClause = isConsignment
    ? "DECIMA PRIMERA: NOTIFICACIONES.- Las partes acuerdan que cualquier citacion o notificacion sera recibidas en las siguientes direcciones: EL INTERMEDIARIO en la Av. 6 de Diciembre y Santa Lucia, Quito, correo electronico veronica.llugcha@autocor.com.ec y, EL CLIENTE en la direccion {{direccion}}, correo electronico {{correo}}. Todas las comunicaciones realizadas a los respectivos correos electronicos, las partes estan de acuerdo que se entenderan como validas y efectivamente realizadas. Si una de las partes modifica su direccion, correo electronico o telefono sera responsabilidad de esta notificar a la otra."
    : "DECIMA PRIMERA: NOTIFICACIONES.- Las partes acuerdan que cualquier comunicacion, citacion o notificacion sera recibidas en las siguientes direcciones: EL INTERMEDIARIO en la Av. 6 de Diciembre y Santa Lucia, Quito, correo electronico vllugcha@autocor.com.ec y, EL CLIENTE en la direccion {{direccion}}, correo electronico {{correo}}. Las partes estan de acuerdo que todas las comunicaciones realizadas a estos correos electronicos se entenderan como validas y efectivamente realizadas. Si una de las partes modifica su direccion, correo electronico o telefono sera responsabilidad de esta notificar a la otra.";
  const controversiesClause = isConsignment
    ...
    : "DECIMA SEGUNDA: CONTROVERSIAS.- En caso de suscitarse controversias que se deriven del presente instrumento las partes buscaran solucionar en primera instancia de buena fe entre estas. EL CLIENTE renuncia fuero y domicilio y las partes se someteran al tramite monitorio, cuando corresponda o al tramite que seleccione EL INTERMEDIARIO, ante los jueces competentes del canton Quito.";
...
const datacilMigrationNotice = document.querySelector("#datacilMigrationNotice");
const antLookupForm = document.querySelector("#antLookupForm");
...
function normalizeProviderLoad(load) {
  ...
  const paidTotal = Number(load.paidTotal ?? load.total ?? 0);
  const reconciledTotal = Number(load.reconciledTotal ?? load.total ?? paidTotal);
  return {
    id: load.id || crypto.randomUUID(),
...
let datacilStoredLookups = [];
let datacilLookupsLoadedAt = 0;
...
function findSavedVehicleLookup(plate = "", excludeTaskId = "") {
  ...
  const taskLookup = state.tasks
    .filter((task) => String(task.id) !== String(excludeTaskId || ""))
    .map((task) => task.vehicleLookup)
    .filter((lookup) => lookup?.placa === normalizedPlate)
    .sort((a, b) => String(b.queriedAt || "").localeCompare(String(a.queriedAt || "")))[0];
  return taskLookup || datacilStoredLookups.find((lookup) => lookup?.placa === normalizedPlate) || null;
}
...
function formatDatacilLabel(key = "") {
  ...
  if (/chasis/i.test(lastPart)) return "RAM";
  return lastPart
    .replace(/[_-]+/g, " ")
...
function getDatacilDisplayEntries(snapshot = {}) {
  ...
  const priority = ["pendiente", "deuda", "multa", "citacion", "valor", "total", "propiet", "nombre", "ident", "cedula", "ruc", "marca", "modelo", "anio", "año", "color", "chasis", "ram", "motor", "clase", "tipo", "servicio", "matricula"];
  return entries
...
function resetDatacilFormSnapshot() {
  ...
  if (datacilMigrationNotice) {
    datacilMigrationNotice.hidden = true;
    datacilMigrationNotice.textContent = "";
  }
}
...
async function callDatacilFunction(body = {}) {
  ...
  if (!apiResponse.ok || !payload.ok) throw new Error(payload.error || "No se pudo completar la consulta.");
  return payload;
}

function upsertDatacilStoredLookup(snapshot = {}) {
  if (!snapshot?.placa) return;
  datacilStoredLookups = [snapshot, ...datacilStoredLookups.filter((item) => item?.placa !== snapshot.placa)]
    .sort((a, b) => String(b.queriedAt || "").localeCompare(String(a.queriedAt || "")));
}

function getDatacilValue(snapshot = {}, patterns = []) {
  const entries = flattenDatacilValues(snapshot.data || {});
...
function migrateDatacilLookupToPurchase(snapshot = {}) {
  ...
  if (datacilMigrationNotice) {
    datacilMigrationNotice.hidden = false;
    datacilMigrationNotice.textContent = `Validación ANT vinculada (${formatDateTime(snapshot.queriedAt)}). Se guardará en la ficha sin consumir otro crédito.`;
  }
  updateDuplicatePreview();
  showToast("Datos de la validación ANT migrados al saneamiento.");
  return true;
}
...
async function queryDatacilVehicle({ plate = "", forceRefresh = false, taskId = "", target = "module" } = {}) {
  ...
  try {
    ...
    if (!payload.snapshot) throw new Error("Datacil no devolvió una consulta utilizable.");
    const snapshot = payload.snapshot;
    upsertDatacilStoredLookup(snapshot);
    renderDatacilStoredLookups();
    if (task) {
...
async function completeSignatureTask(taskId) {
  ...
  const source = state.tasks.find((item) => String(item.id) === String(task.sourceTaskId || ""));
  task.status = "saneamiento realizado y subido a pilot";
  task.completedAt = now;
  task.updatedAt = now;
  task.statusLockedAt = now;
...
function setCommercialProcessFromTarget(target, shouldScroll = true, options = {}) {
  ...
  renderCommercialDashboard();
  if (target === "commercial-ant-process") loadDatacilStoredLookups();
...
function renderProviderKpis(records) {
  ...
  const providers = new Set(records.map((record) => record.provider).filter(Boolean)).size;
  providerKpis.innerHTML = [
    ["paid", "Gasto pagado", `$ ${paidTotal.toFixed(2)}`, "Suma real de la columna valor", "is-success"],
  ...
  providerExecutiveDashboard.innerHTML = `
    <section class="provider-exec-shell">
      ...
      <div class="provider-exec-kpi-grid">
        ${renderProviderExecKpi("&#128176;", "Gasto pagado", `$ ${metrics.paidTotal.toFixed(2)}`, "Suma real de la columna valor", "paid", "success")}
...
function buildProviderReportHtml() {
  ...
  const topProviders = [...new Map(records.map((record) => [record.provider, 0]))].map(([provider]) => {
    ...
    return {
      provider,
      total: getProviderPaidAmount(providerRecords),
...
<body>
  ...
  <main class="sheet">
    ...
    <section class="kpis">
      <article class="kpi good"><span>Gasto pagado</span><strong>$ ${paidTotal.toFixed(2)}</strong><small>Suma real de la columna valor</small></article>
...
<body>
  ...
  <main class="sheet">
    ...
    <section class="kpis">
      <article class="kpi green"><span>Gasto pagado</span><strong>$ ${paidTotal.toFixed(2)}</strong><small>Suma real de la columna valor</small></article>
      <article class="kpi"><span>Sobrecobro autorizado</span><strong>$ ${authorizedOvercharge.toFixed(2)}</strong><small>Duplicados aprobados</small></article>
      <article class="kpi"><span>Registros</span><strong>${records.length}</strong><small>Filas analizadas</small></article>
      <article class="kpi"><span>Placas unicas</span><strong>${uniquePlates}</strong><small>Solo celda PLACA</small></article>
...
document.addEventListener("click", async (event) => {
  ...
  if (datacilMigrateButton) {
    event.preventDefault();
    const snapshot = findSavedVehicleLookup(datacilMigrateButton.dataset.datacilMigrate);
    if (snapshot && migrateDatacilLookupToPurchase(snapshot)) setCommercialProcessFromTarget("commercial-purchase-process");
    return;
  }
...
purchasePlateInput?.addEventListener("change", offerDatacilMigrationForPlate);

antLookupPlate?.addEventListener("input", () => {
  const normalizedPlate = normalizePlate(antLookupPlate.value);
  if (antLookupPlate.value !== normalizedPlate) antLookupPlate.value = normalizedPlate;
});

antLookupForm?.addEventListener("submit", async (event) => {
  event.preventDefault();
  await queryDatacilVehicle({ plate: antLookupPlate?.value || "", target: "module" });
});
